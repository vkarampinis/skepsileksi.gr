...
function Target() {
  return (
    ...
    >
      ...
      ρόλος μου ως μητέρα δύο αξιαγάπητων παιδιών, απλά μου το επιβεβαίωσε ενώ
      παράλληλα με βοήθησε ώστε να το κατανοήσω σε βάθος. Αποστολή μου, λοιπόν,
      είναι όχι μόνο να βοηθήσω το παιδί σου αλλά και για να σου δείξω το δρόμο
      για το πώς θα γίνεις ουσιαστικό μέρος της θεραπείας του.
    </ColoredSection>
  );
}
    ...
    <section>
      <div className="max-w-6xl px-4 mx-auto my-12 sm:my-24 ">
        ...
        <AdvantageItem title={"Προσβάσιμη"} icon={icon}>
          Η απόσταση δεν αποτελεί πλέον πρόβλημα. Συνδέεσαι απ’ οπουδήποτε και
          είναι εύκολη στην εφαρμογή.
        </AdvantageItem>
        <AdvantageItem title={"Λιγότερο άγχος"} icon={icon}>
          Η θεραπεία στο σπίτι, σας απαλλάσει από τις μετακινήσεις και το άγχος
...
function Together() {
  return (
    <ColoredSection
      ...
      title={"Μαζί μπορούμε"}
    >
      Τα παιδία είναι ικανά για σπουδαία πράγματα. Είμαι εδώ λοιπόν, για να τα
      ...
      <div className="flex flex-col max-w-6xl mx-auto mt-12 md:flex-row">
        <div className="sm:px-28 md:px-0 md:basis-1/2 lg:basis-6/12">
          <Card className="max-w-md">
            ...
            <CardItem>υπολογιστής ή tablet με μικρόφωνο και κάμερα</CardItem>
