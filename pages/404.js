...
export default function Custom404() {
  return (
    <BaseLayout>
      <TextSection>
        <H size={2} className="mt-20 text-center">
          Η σελίδα δεν βρέθηκε!
        </H>
        <div className="w-64 m-auto md:w-96">
          <svg
          ...
          >
            ...
            <g data-name="Layer 12">
              ...
              <g>
                <path
                  className={
                    styles.cls1 + " " + styles.circle + " " + styles.c1
                  }
                ...
                <path
                  className={
                    styles.cls1 + " " + styles.circle + " " + styles.c2
                  }
                ...
                <path
                  className={
                    styles.cls1 + " " + styles.circle + " " + styles.c3
                  }
                ...
                <path
                  className={
                    styles.cls1 + " " + styles.circle + " " + styles.c4
                  }
                ...
                <path
                  className={
                    styles.cls1 + " " + styles.circle + " " + styles.c5
                  }
                ...
                <path
                  className={
                    styles.cls1 + " " + styles.circle + " " + styles.c6
                  }
            ...
            <g id={styles.clock} data-name="Layer 8">
              ...
              />
              <rect
                className={styles.cls3 + " " + styles.clockHand1}
                x="845"
                y="189.5"
                width="6.04"
                height="58"
              ...
              />
              <rect
                className={styles.cls3 + " " + styles.clockHand2}
                x="845"
                y="209.5"
                width="6.04"
                height="38"
            ...
            <g id={styles.bike} data-name="Layer 5">
              <path
                className={styles.cls8 + " " + styles.wheel}
          ...
          <Button link={links.Home} className="block mt-10 ">
            Επιστροφή
          </Button>
        </div>
      </TextSection>
